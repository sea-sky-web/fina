...
def simulate(
    ...
    # V44: Cross-sectional dispersion filter
    ...
    for d in dates:
        ...
        # V44: Bear market half-position scaling
        if bear_mask.loc[d]:
...
def main() -> None:
    ...
    report = judge_report(close, symbols, result, "V44")

    print("\n=== JUDGE REPORT V44 ===")
    print(json.dumps({k: v for k, v in report.items() if k != "windows_detail"}, ensure_ascii=False, indent=2))

    output_dir = Path("/Users/ster/Desktop/fina/artifacts/backtest_v44")
