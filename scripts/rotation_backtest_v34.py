...
def simulate(
    ...
    for d in dates:
        ...
        # V34: Bear market half-position scaling
        if bear_mask.loc[d]:
...
def main() -> None:
    ...
    report = judge_report(close, symbols, result, "V34")

    print("\n=== JUDGE REPORT V34 ===")
    print(json.dumps({k: v for k, v in report.items() if k != "windows_detail"}, ensure_ascii=False, indent=2))

    output_dir = Path("/Users/ster/Desktop/fina/artifacts/backtest_v34")
