Create one horizontal animation strip for Codex pet `looplet`, state `running-right`.
...
Identity: same pet in every frame: A tiny helpful research robot pet with a multi-view camera visor, compact rounded body, small calibration-grid cape, and tool-belt details suggesting reproducible baselines, Colab experiment loops, academic slide craft, and durable Codex skills. No text or logos.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
Style: Pet-safe sprite: compact full-body mascot, readable in a 192x208 cell, clear silhouette, simple face, stable palette/materials, and crisp edges for chroma-key extraction. Style `3d-toy`: Stylized 3D toy mascot with smooth rounded forms, simple materials, clear silhouette, and no photoreal complexity. User style notes: polished tiny 3D toy mascot, readable at 192x208 sprite size, teal graphite white and warm yellow accents, clean silhouette, no readable text.
