...
_BOND_KW = ("国债", "国开", "政金债", "地方债", "城投债", "企债", "公司债", "信用债", "可转债", "债券", "短融", "利率")
_CROSS_BORDER_KW = ("纳斯达克", "纳指", "标普", "日经", "恒生", "恒指", "H股", "中概", "港股", "德国", "法国", "东南亚", "越南", "印度", "沙特", "韩国")
_BROAD_KW = ("沪深300", "中证500", "中证1000", "上证50", "创业板", "科创", "红利", "深证100", "中证A")
