...
def simulate(
    ...
    # V48: Cross-sectional dispersion filter
    ...
    for d in dates:
        ...
        # V48: Bear market half-position scaling
        if bear_mask.loc[d]:
...
def main() -> None:
    ...
    report = judge_report(close, symbols, result, "V48")

    print("\n=== JUDGE REPORT V48 ===")
    print(json.dumps({k: v for k, v in report.items() if k != "windows_detail"}, ensure_ascii=False, indent=2))

    output_dir = Path("/Users/ster/Desktop/fina/artifacts/backtest_v48")
